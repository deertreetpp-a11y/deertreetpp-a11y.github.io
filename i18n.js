...
const I18N_TH = [
  [".nav-links a", ["Tech Stack", "ผลงาน <sup>06</sup>"]],
  ...
  [".xp-role", [
    "นักศึกษาฝึกงาน แผนก Goods Receiving (GR) — เมษายน 2569 ตรวจรับสินค้าเข้า-ออกทั้งระบบ Credit และ Consignment คีย์ข้อมูลเข้าระบบ แล้วกระจายขึ้นชั้นให้ถูกแผนก",
  ...
  [".stat-label", ["ยอดวิวไอจี", "บรรทัดที่แปล", "ธุรกิจที่ก่อตั้ง", "แชมป์แฮ็กกาธอน"]],
  [".stat-foot", ["คลิปแจก Claude Skill ฟรี", "ModKrub — Ready or Not แจกฟรี", "Haru &amp; Torb Hai เปิดจริงทั้งคู่", "Krungsri UniVerse 2025"]],
