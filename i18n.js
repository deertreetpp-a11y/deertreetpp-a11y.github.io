...
const I18N_TH = [
  ...
  [".xp-role", [
    ...
    "รางวัลชนะเลิศ ระดับภูมิภาค — แพลตฟอร์มห้องเรียนที่ช่วยแบ่งเบาภาระการตรวจงานของครู และทำให้นักเรียนเข้าใจว่าตัวเองพลาดตรงไหน ได้ไปต่อรอบระดับประเทศ",
