...
const I18N_TH = [
  ...
  [".intro .big-text", ["ผมชื่อเดียร์ — นักศึกษาผู้ประกอบการดิจิทัล ม.ขอนแก่น สำหรับผม AI ไม่ใช่ทางลัด แต่คือทีมโปรดักชันของผม ทุกโปรเจกต์เริ่มจากวิจัยตลาดจริง แล้วส่งงานเป็นวัน ไม่ใช่เป็นสัปดาห์ — และนี่คือชุดเครื่องมือที่ผมใช้ลุยงาน:"]],
