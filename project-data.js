...
const PROJECT_PAGES = {
  ...
  jump: {
    ...
    tagline: {
      ...
      th: "รางวัลชนะเลิศ การแข่งขันระดับภูมิภาค — แพลตฟอร์มห้องเรียนที่ช่วยแบ่งเบาภาระการตรวจงานของครู และทำให้นักเรียนเข้าใจว่าตัวเองพลาดตรงไหน โดย AI เป็นคนตรวจและเสนอแนะ ส่วนครูเป็นคนตัดสิน",
    },
    desc: {
