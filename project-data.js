...
const PROJECT_PAGES = {
  ...
  jump: {
    ...
    tagline: {
      en: "First place in the regional round — a classroom platform that takes the marking load off teachers and helps students understand where their own thinking went wrong. The AI proposes; the teacher decides.",
      th: "รางวัลชนะเลิศ การแข่งขันระดับภูมิภาค — แพลตฟอร์มห้องเรียนที่ช่วยแบ่งเบาภาระการตรวจงานของครู และทำให้นักเรียนเข้าใจว่าตัวเองพลาดตรงไหน โดย AI เป็นคนเสนอ ครูเป็นคนตัดสิน",
    },
    desc: {
