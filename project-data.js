...
const PROJECT_PAGES = {
  ...
  muvita: {
    title: "MUVITA",
    service: "Research", client: "R2M 2025", year: "2025",
    bg: "linear-gradient(135deg,#1b2926,#0f8071)", glyph: "MU",
    tagline: {
      en: "Research to Market — turning lab research into a sellable product case.",
      th: "Research to Market — เปลี่ยนงานวิจัยในแล็บให้เป็นเคสสินค้าที่ขายได้",
    },
    desc: {
      en: "Pain-point discovery, feasibility and go-to-market thinking for a university research project.",
      th: "ค้นหา pain point วิเคราะห์ความเป็นไปได้ และวางแนวคิด go-to-market ให้งานวิจัยมหาวิทยาลัย",
    },
    media: [],
  },
};
